...
parser.add_argument("--tie_every_n_batches", type=int, dest='tie_every_n_batches', default=1, help="help")
parser.add_argument("--lr", type=float, dest='lr', default=.01, help="help")
parser.add_argument("--momentum", type=float, dest='momentum', default=.9, help="help")
parser.add_argument("--dataset", type=str, dest='dataset', default='MNIST', help="help")
parser.add_argument("--init_scale", type=float, dest='init_scale', default=.01, help="help")
parser.add_argument("--net", type=str, dest='net', default='LeNet', help="help")
parser.add_argument("--which_trainer", type=str, dest='which_trainer', default='zhouhan', help="help")
