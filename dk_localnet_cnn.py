...
print "\n... pre-processing"
if 1:
    train_x, train_y = load_mnist(path = '/Users/david/datasets/')
...
ttime = time.time()
print (weights[0][0][0]**2).eval().sum()
if 1: # start with shared weights! TODO: this will probably be close to 0 due to randomness!
    sharify_fn()
print (weights[0][0][0]**2).eval().sum()
ipdb.set_trace()
